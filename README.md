...
* **KICS 2024** · 멀티 센서 기반의 스마트홈 공기질 향상을 위한 모니터링 시스템
* **IEEK 2024** · 최적 스팀량 예측 인공지능 모델을 통한 공정의 에너지 효율 개선 모니터링 시스템
* **KICS 2024** · 딥러닝 전처리 모델 및 클러스터링 분석을 활용한 주거용 건물 실시간 공기질 모니터링 플랫폼
